...
**GitHub Issue**: #28
**Branch**: `issue-28-1`
**Figma Link**: https://www.figma.com/design/5NQAM48PSavkdGzGHtipcD/%E3%80%90%E5%AE%8C%E4%BA%86%E3%80%91%E5%90%89%E5%B7%9D%E5%95%86%E4%BA%8B%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE--Copy-?node-id=111-48{FIGMA_LINK}p=f{FIGMA_LINK}t=k4T5zU6D7Nbj7TcW-0{FIGMA_LINK}node-id=176-65
**Complexity**: 5/10
**Created**: 2025-10-08T06:31:05Z
...
- [ ] BEM CSS classes applied (`.1__element--modifier`)
- [ ] All styles in `css/1.css`
- [ ] JavaScript in `js/1.js` (if interactive)
- [ ] No hard-coded colors (use CSS variables)
- [ ] No magic numbers (use spacing variables)

### Automated Tests (Playwright)
Test file: `tests/1.spec.js`
...
- [ ] HTML copied to `theme/{sections|snippets}/1.liquid`
...
```
2025-10-08T06:31:05Z - Phase 1 started
2025-10-08T06:31:05Z - Figma analysis complete
2025-10-08T06:31:05Z - Phase 1 complete ✓

2025-10-08T06:31:05Z - Phase 2 started
2025-10-08T06:31:05Z - HTML structure created
2025-10-08T06:31:05Z - CSS implemented (BEM naming)
2025-10-08T06:31:05Z - JavaScript added (if needed)
2025-10-08T06:31:05Z - Playwright tests created
2025-10-08T06:31:05Z - Running visual validation...
2025-10-08T06:31:05Z - Test results: Desktop: _%, Tablet: _%, Mobile: _%
2025-10-08T06:31:05Z - Phase 2 complete ✓

2025-10-08T06:31:05Z - Phase 3 started
2025-10-08T06:31:05Z - HTML converted to Liquid
2025-10-08T06:31:05Z - Section schema added
2025-10-08T06:31:05Z - Shopify preview validated
2025-10-08T06:31:05Z - Phase 3 complete ✓

2025-10-08T06:31:05Z - **TASK COMPLETE - Ready for PR**
```
...
- `html/1.html`
- `css/1.css`
- `js/1.js` (if interactive)
- `tests/1.spec.js`
- `tests/screenshots/1-desktop.png`
- `tests/screenshots/1-tablet.png`
- `tests/screenshots/1-mobile.png`

### Phase 3: Liquid Conversion
- `theme/sections/1.liquid` (if section) OR
- `theme/snippets/1.liquid` (if snippet/component)
