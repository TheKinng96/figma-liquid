...
**GitHub Issue**: #18
**Branch**: `issue-18-sp-top`
**Figma Link**: https://www.figma.com/design/5NQAM48PSavkdGzGHtipcD/%E3%80%90%E5%AE%8C%E4%BA%86%E3%80%91%E5%90%89%E5%B7%9D%E5%95%86%E4%BA%8B%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE--Copy-?node-id=111-48{FIGMA_LINK}p=f{FIGMA_LINK}t=k4T5zU6D7Nbj7TcW-0{FIGMA_LINK}node-id=111-856
**Complexity**: 8/10
**Created**: 2025-10-08T06:29:56Z
...
- [ ] BEM CSS classes applied (`.sp-top__element--modifier`)
- [ ] All styles in `css/sp-top.css`
- [ ] JavaScript in `js/sp-top.js` (if interactive)
- [ ] No hard-coded colors (use CSS variables)
- [ ] No magic numbers (use spacing variables)

### Automated Tests (Playwright)
Test file: `tests/sp-top.spec.js`
...
- [ ] HTML copied to `theme/{sections|snippets}/sp-top.liquid`
...
```
2025-10-08T06:29:56Z - Phase 1 started
2025-10-08T06:29:56Z - Figma analysis complete
2025-10-08T06:29:56Z - Phase 1 complete ✓

2025-10-08T06:29:56Z - Phase 2 started
2025-10-08T06:29:56Z - HTML structure created
2025-10-08T06:29:56Z - CSS implemented (BEM naming)
2025-10-08T06:29:56Z - JavaScript added (if needed)
2025-10-08T06:29:56Z - Playwright tests created
2025-10-08T06:29:56Z - Running visual validation...
2025-10-08T06:29:56Z - Test results: Desktop: _%, Tablet: _%, Mobile: _%
2025-10-08T06:29:56Z - Phase 2 complete ✓

2025-10-08T06:29:56Z - Phase 3 started
2025-10-08T06:29:56Z - HTML converted to Liquid
2025-10-08T06:29:56Z - Section schema added
2025-10-08T06:29:56Z - Shopify preview validated
2025-10-08T06:29:56Z - Phase 3 complete ✓

2025-10-08T06:29:56Z - **TASK COMPLETE - Ready for PR**
```
...
- `html/sp-top.html`
- `css/sp-top.css`
- `js/sp-top.js` (if interactive)
- `tests/sp-top.spec.js`
- `tests/screenshots/sp-top-desktop.png`
- `tests/screenshots/sp-top-tablet.png`
- `tests/screenshots/sp-top-mobile.png`

### Phase 3: Liquid Conversion
- `theme/sections/sp-top.liquid` (if section) OR
- `theme/snippets/sp-top.liquid` (if snippet/component)
