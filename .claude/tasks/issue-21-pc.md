...
**GitHub Issue**: #21
**Branch**: `issue-21-pc`
**Figma Link**: https://www.figma.com/design/5NQAM48PSavkdGzGHtipcD/%E3%80%90%E5%AE%8C%E4%BA%86%E3%80%91%E5%90%89%E5%B7%9D%E5%95%86%E4%BA%8B%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE--Copy-?node-id=111-48{FIGMA_LINK}p=f{FIGMA_LINK}t=k4T5zU6D7Nbj7TcW-0{FIGMA_LINK}node-id=111-2244
**Complexity**: 7/10
**Created**: 2025-10-08T06:30:26Z
...
- [ ] Complexity score: 7 (recommended: ≤7)
...
- [ ] BEM CSS classes applied (`.pc__element--modifier`)
- [ ] All styles in `css/pc.css`
- [ ] JavaScript in `js/pc.js` (if interactive)
- [ ] No hard-coded colors (use CSS variables)
- [ ] No magic numbers (use spacing variables)

### Automated Tests (Playwright)
Test file: `tests/pc.spec.js`
...
- [ ] HTML copied to `theme/{sections|snippets}/pc.liquid`
...
```
2025-10-08T06:30:26Z - Phase 1 started
2025-10-08T06:30:26Z - Figma analysis complete
2025-10-08T06:30:26Z - Phase 1 complete ✓

2025-10-08T06:30:26Z - Phase 2 started
2025-10-08T06:30:26Z - HTML structure created
2025-10-08T06:30:26Z - CSS implemented (BEM naming)
2025-10-08T06:30:26Z - JavaScript added (if needed)
2025-10-08T06:30:26Z - Playwright tests created
2025-10-08T06:30:26Z - Running visual validation...
2025-10-08T06:30:26Z - Test results: Desktop: _%, Tablet: _%, Mobile: _%
2025-10-08T06:30:26Z - Phase 2 complete ✓

2025-10-08T06:30:26Z - Phase 3 started
2025-10-08T06:30:26Z - HTML converted to Liquid
2025-10-08T06:30:26Z - Section schema added
2025-10-08T06:30:26Z - Shopify preview validated
2025-10-08T06:30:26Z - Phase 3 complete ✓

2025-10-08T06:30:26Z - **TASK COMPLETE - Ready for PR**
```
...
- `html/pc.html`
- `css/pc.css`
- `js/pc.js` (if interactive)
- `tests/pc.spec.js`
- `tests/screenshots/pc-desktop.png`
- `tests/screenshots/pc-tablet.png`
- `tests/screenshots/pc-mobile.png`

### Phase 3: Liquid Conversion
- `theme/sections/pc.liquid` (if section) OR
- `theme/snippets/pc.liquid` (if snippet/component)
