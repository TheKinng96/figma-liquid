...
**GitHub Issue**: #9
**Branch**: `issue-9-pc-top`
**Figma Link**: https://www.figma.com/design/5NQAM48PSavkdGzGHtipcD/%E3%80%90%E5%AE%8C%E4%BA%86%E3%80%91%E5%90%89%E5%B7%9D%E5%95%86%E4%BA%8B%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE--Copy-?node-id=111-48{FIGMA_LINK}p=f{FIGMA_LINK}t=k4T5zU6D7Nbj7TcW-0{FIGMA_LINK}node-id=111-58
**Complexity**: 8/10
**Created**: 2025-10-07T03:44:16Z
...
- [ ] BEM CSS classes applied (`.pc-top__element--modifier`)
- [ ] All styles in `css/pc-top.css`
- [ ] JavaScript in `js/pc-top.js` (if interactive)
- [ ] No hard-coded colors (use CSS variables)
- [ ] No magic numbers (use spacing variables)

### Automated Tests (Playwright)
Test file: `tests/pc-top.spec.js`
...
- [ ] HTML copied to `theme/{sections|snippets}/pc-top.liquid`
...
```
2025-10-07T03:44:16Z - Phase 1 started
2025-10-07T03:44:16Z - Figma analysis complete
2025-10-07T03:44:16Z - Phase 1 complete ✓

2025-10-07T03:44:16Z - Phase 2 started
2025-10-07T03:44:16Z - HTML structure created
2025-10-07T03:44:16Z - CSS implemented (BEM naming)
2025-10-07T03:44:16Z - JavaScript added (if needed)
2025-10-07T03:44:16Z - Playwright tests created
2025-10-07T03:44:16Z - Running visual validation...
2025-10-07T03:44:16Z - Test results: Desktop: _%, Tablet: _%, Mobile: _%
2025-10-07T03:44:16Z - Phase 2 complete ✓

2025-10-07T03:44:16Z - Phase 3 started
2025-10-07T03:44:16Z - HTML converted to Liquid
2025-10-07T03:44:16Z - Section schema added
2025-10-07T03:44:16Z - Shopify preview validated
2025-10-07T03:44:16Z - Phase 3 complete ✓

2025-10-07T03:44:16Z - **TASK COMPLETE - Ready for PR**
```
...
- `html/pc-top.html`
- `css/pc-top.css`
- `js/pc-top.js` (if interactive)
- `tests/pc-top.spec.js`
- `tests/screenshots/pc-top-desktop.png`
- `tests/screenshots/pc-top-tablet.png`
- `tests/screenshots/pc-top-mobile.png`

### Phase 3: Liquid Conversion
- `theme/sections/pc-top.liquid` (if section) OR
- `theme/snippets/pc-top.liquid` (if snippet/component)
