...
**GitHub Issue**: #24
**Branch**: `issue-24-frame-1684`
**Figma Link**: https://www.figma.com/design/5NQAM48PSavkdGzGHtipcD/%E3%80%90%E5%AE%8C%E4%BA%86%E3%80%91%E5%90%89%E5%B7%9D%E5%95%86%E4%BA%8B%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE--Copy-?node-id=111-48{FIGMA_LINK}p=f{FIGMA_LINK}t=k4T5zU6D7Nbj7TcW-0{FIGMA_LINK}node-id=111-3305
**Complexity**: 5/10
**Created**: 2025-10-08T06:30:51Z
...
- [ ] BEM CSS classes applied (`.frame-1684__element--modifier`)
- [ ] All styles in `css/frame-1684.css`
- [ ] JavaScript in `js/frame-1684.js` (if interactive)
- [ ] No hard-coded colors (use CSS variables)
- [ ] No magic numbers (use spacing variables)

### Automated Tests (Playwright)
Test file: `tests/frame-1684.spec.js`
...
- [ ] HTML copied to `theme/{sections|snippets}/frame-1684.liquid`
...
```
2025-10-08T06:30:51Z - Phase 1 started
2025-10-08T06:30:51Z - Figma analysis complete
2025-10-08T06:30:51Z - Phase 1 complete ✓

2025-10-08T06:30:51Z - Phase 2 started
2025-10-08T06:30:51Z - HTML structure created
2025-10-08T06:30:51Z - CSS implemented (BEM naming)
2025-10-08T06:30:51Z - JavaScript added (if needed)
2025-10-08T06:30:51Z - Playwright tests created
2025-10-08T06:30:51Z - Running visual validation...
2025-10-08T06:30:51Z - Test results: Desktop: _%, Tablet: _%, Mobile: _%
2025-10-08T06:30:51Z - Phase 2 complete ✓

2025-10-08T06:30:51Z - Phase 3 started
2025-10-08T06:30:51Z - HTML converted to Liquid
2025-10-08T06:30:51Z - Section schema added
2025-10-08T06:30:51Z - Shopify preview validated
2025-10-08T06:30:51Z - Phase 3 complete ✓

2025-10-08T06:30:51Z - **TASK COMPLETE - Ready for PR**
```
...
- `html/frame-1684.html`
- `css/frame-1684.css`
- `js/frame-1684.js` (if interactive)
- `tests/frame-1684.spec.js`
- `tests/screenshots/frame-1684-desktop.png`
- `tests/screenshots/frame-1684-tablet.png`
- `tests/screenshots/frame-1684-mobile.png`

### Phase 3: Liquid Conversion
- `theme/sections/frame-1684.liquid` (if section) OR
- `theme/snippets/frame-1684.liquid` (if snippet/component)
