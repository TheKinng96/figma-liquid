# Task #: PC_コレクションテンプレート（ブランド）_Frame 1661

**GitHub Issue**: #
**Branch**: `issue--pc-4`
**Figma Link**: https://www.figma.com/design/5NQAM48PSavkdGzGHtipcD/%E3%80%90%E5%AE%8C%E4%BA%86%E3%80%91%E5%90%89%E5%B7%9D%E5%95%86%E4%BA%8B%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE--Copy-?node-id=111-48{FIGMA_LINK}p=f{FIGMA_LINK}t=k4T5zU6D7Nbj7TcW-0{FIGMA_LINK}node-id=111-2697
**Complexity**: 5/10
**Created**: 2025-10-08T06:30:39Z
...
- [ ] BEM CSS classes applied (`.pc-4__element--modifier`)
- [ ] All styles in `css/pc-4.css`
- [ ] JavaScript in `js/pc-4.js` (if interactive)
- [ ] No hard-coded colors (use CSS variables)
- [ ] No magic numbers (use spacing variables)

### Automated Tests (Playwright)
Test file: `tests/pc-4.spec.js`
...
- [ ] HTML copied to `theme/{sections|snippets}/pc-4.liquid`
...
```
2025-10-08T06:30:39Z - Phase 1 started
2025-10-08T06:30:39Z - Figma analysis complete
2025-10-08T06:30:39Z - Phase 1 complete ✓

2025-10-08T06:30:39Z - Phase 2 started
2025-10-08T06:30:39Z - HTML structure created
2025-10-08T06:30:39Z - CSS implemented (BEM naming)
2025-10-08T06:30:39Z - JavaScript added (if needed)
2025-10-08T06:30:39Z - Playwright tests created
2025-10-08T06:30:39Z - Running visual validation...
2025-10-08T06:30:39Z - Test results: Desktop: _%, Tablet: _%, Mobile: _%
2025-10-08T06:30:39Z - Phase 2 complete ✓

2025-10-08T06:30:39Z - Phase 3 started
2025-10-08T06:30:39Z - HTML converted to Liquid
2025-10-08T06:30:39Z - Section schema added
2025-10-08T06:30:39Z - Shopify preview validated
2025-10-08T06:30:39Z - Phase 3 complete ✓

2025-10-08T06:30:39Z - **TASK COMPLETE - Ready for PR**
```
...
- `html/pc-4.html`
- `css/pc-4.css`
- `js/pc-4.js` (if interactive)
- `tests/pc-4.spec.js`
- `tests/screenshots/pc-4-desktop.png`
- `tests/screenshots/pc-4-tablet.png`
- `tests/screenshots/pc-4-mobile.png`

### Phase 3: Liquid Conversion
- `theme/sections/pc-4.liquid` (if section) OR
- `theme/snippets/pc-4.liquid` (if snippet/component)
...
```json
{
  "name": "PC_コレクションテンプレート（ブランド）_Frame 1661",
  "settings": [
    {
      "type": "text",
      "id": "heading",
