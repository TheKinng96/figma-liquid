...
**GitHub Issue**: #19
**Branch**: `issue-19-sp`
**Figma Link**: https://www.figma.com/design/5NQAM48PSavkdGzGHtipcD/%E3%80%90%E5%AE%8C%E4%BA%86%E3%80%91%E5%90%89%E5%B7%9D%E5%95%86%E4%BA%8B%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE--Copy-?node-id=111-48{FIGMA_LINK}p=f{FIGMA_LINK}t=k4T5zU6D7Nbj7TcW-0{FIGMA_LINK}node-id=111-1875
**Complexity**: 7/10
**Created**: 2025-10-08T06:30:19Z
...
- [ ] BEM CSS classes applied (`.sp__element--modifier`)
- [ ] All styles in `css/sp.css`
- [ ] JavaScript in `js/sp.js` (if interactive)
- [ ] No hard-coded colors (use CSS variables)
- [ ] No magic numbers (use spacing variables)

### Automated Tests (Playwright)
Test file: `tests/sp.spec.js`
...
- [ ] HTML copied to `theme/{sections|snippets}/sp.liquid`
...
```
2025-10-08T06:30:19Z - Phase 1 started
2025-10-08T06:30:19Z - Figma analysis complete
2025-10-08T06:30:19Z - Phase 1 complete ✓

2025-10-08T06:30:19Z - Phase 2 started
2025-10-08T06:30:19Z - HTML structure created
2025-10-08T06:30:19Z - CSS implemented (BEM naming)
2025-10-08T06:30:19Z - JavaScript added (if needed)
2025-10-08T06:30:19Z - Playwright tests created
2025-10-08T06:30:19Z - Running visual validation...
2025-10-08T06:30:19Z - Test results: Desktop: _%, Tablet: _%, Mobile: _%
2025-10-08T06:30:19Z - Phase 2 complete ✓

2025-10-08T06:30:19Z - Phase 3 started
2025-10-08T06:30:19Z - HTML converted to Liquid
2025-10-08T06:30:19Z - Section schema added
2025-10-08T06:30:19Z - Shopify preview validated
2025-10-08T06:30:19Z - Phase 3 complete ✓

2025-10-08T06:30:19Z - **TASK COMPLETE - Ready for PR**
```
...
- `html/sp.html`
- `css/sp.css`
- `js/sp.js` (if interactive)
- `tests/sp.spec.js`
- `tests/screenshots/sp-desktop.png`
- `tests/screenshots/sp-tablet.png`
- `tests/screenshots/sp-mobile.png`

### Phase 3: Liquid Conversion
- `theme/sections/sp.liquid` (if section) OR
- `theme/snippets/sp.liquid` (if snippet/component)
