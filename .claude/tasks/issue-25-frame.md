...
**GitHub Issue**: #25
**Branch**: `issue-25-frame`
**Figma Link**: https://www.figma.com/design/5NQAM48PSavkdGzGHtipcD/%E3%80%90%E5%AE%8C%E4%BA%86%E3%80%91%E5%90%89%E5%B7%9D%E5%95%86%E4%BA%8B%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE--Copy-?node-id=111-48{FIGMA_LINK}p=f{FIGMA_LINK}t=k4T5zU6D7Nbj7TcW-0{FIGMA_LINK}node-id=118-3374
**Complexity**: 5/10
**Created**: 2025-10-08T06:30:55Z
...
- [ ] BEM CSS classes applied (`.frame__element--modifier`)
- [ ] All styles in `css/frame.css`
- [ ] JavaScript in `js/frame.js` (if interactive)
- [ ] No hard-coded colors (use CSS variables)
- [ ] No magic numbers (use spacing variables)

### Automated Tests (Playwright)
Test file: `tests/frame.spec.js`
...
- [ ] HTML copied to `theme/{sections|snippets}/frame.liquid`
...
```
2025-10-08T06:30:55Z - Phase 1 started
2025-10-08T06:30:55Z - Figma analysis complete
2025-10-08T06:30:55Z - Phase 1 complete ✓

2025-10-08T06:30:55Z - Phase 2 started
2025-10-08T06:30:55Z - HTML structure created
2025-10-08T06:30:55Z - CSS implemented (BEM naming)
2025-10-08T06:30:55Z - JavaScript added (if needed)
2025-10-08T06:30:55Z - Playwright tests created
2025-10-08T06:30:55Z - Running visual validation...
2025-10-08T06:30:55Z - Test results: Desktop: _%, Tablet: _%, Mobile: _%
2025-10-08T06:30:55Z - Phase 2 complete ✓

2025-10-08T06:30:55Z - Phase 3 started
2025-10-08T06:30:55Z - HTML converted to Liquid
2025-10-08T06:30:55Z - Section schema added
2025-10-08T06:30:55Z - Shopify preview validated
2025-10-08T06:30:55Z - Phase 3 complete ✓

2025-10-08T06:30:55Z - **TASK COMPLETE - Ready for PR**
```
...
- `html/frame.html`
- `css/frame.css`
- `js/frame.js` (if interactive)
- `tests/frame.spec.js`
- `tests/screenshots/frame-desktop.png`
- `tests/screenshots/frame-tablet.png`
- `tests/screenshots/frame-mobile.png`

### Phase 3: Liquid Conversion
- `theme/sections/frame.liquid` (if section) OR
- `theme/snippets/frame.liquid` (if snippet/component)
