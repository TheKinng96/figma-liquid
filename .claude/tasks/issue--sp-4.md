# Task #: SP_コレクションテンプレート（ブランド）_Frame 1608

**GitHub Issue**: #
**Branch**: `issue--sp-4`
**Figma Link**: https://www.figma.com/design/5NQAM48PSavkdGzGHtipcD/%E3%80%90%E5%AE%8C%E4%BA%86%E3%80%91%E5%90%89%E5%B7%9D%E5%95%86%E4%BA%8B%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE--Copy-?node-id=111-48{FIGMA_LINK}p=f{FIGMA_LINK}t=k4T5zU6D7Nbj7TcW-0{FIGMA_LINK}node-id=111-1376
**Complexity**: 5/10
**Created**: 2025-10-08T06:30:10Z
...
- [ ] BEM CSS classes applied (`.sp-4__element--modifier`)
- [ ] All styles in `css/sp-4.css`
- [ ] JavaScript in `js/sp-4.js` (if interactive)
- [ ] No hard-coded colors (use CSS variables)
- [ ] No magic numbers (use spacing variables)

### Automated Tests (Playwright)
Test file: `tests/sp-4.spec.js`
...
- [ ] HTML copied to `theme/{sections|snippets}/sp-4.liquid`
...
```
2025-10-08T06:30:10Z - Phase 1 started
2025-10-08T06:30:10Z - Figma analysis complete
2025-10-08T06:30:10Z - Phase 1 complete ✓

2025-10-08T06:30:10Z - Phase 2 started
2025-10-08T06:30:10Z - HTML structure created
2025-10-08T06:30:10Z - CSS implemented (BEM naming)
2025-10-08T06:30:10Z - JavaScript added (if needed)
2025-10-08T06:30:10Z - Playwright tests created
2025-10-08T06:30:10Z - Running visual validation...
2025-10-08T06:30:10Z - Test results: Desktop: _%, Tablet: _%, Mobile: _%
2025-10-08T06:30:10Z - Phase 2 complete ✓

2025-10-08T06:30:10Z - Phase 3 started
2025-10-08T06:30:10Z - HTML converted to Liquid
2025-10-08T06:30:10Z - Section schema added
2025-10-08T06:30:10Z - Shopify preview validated
2025-10-08T06:30:10Z - Phase 3 complete ✓

2025-10-08T06:30:10Z - **TASK COMPLETE - Ready for PR**
```
...
- `html/sp-4.html`
- `css/sp-4.css`
- `js/sp-4.js` (if interactive)
- `tests/sp-4.spec.js`
- `tests/screenshots/sp-4-desktop.png`
- `tests/screenshots/sp-4-tablet.png`
- `tests/screenshots/sp-4-mobile.png`

### Phase 3: Liquid Conversion
- `theme/sections/sp-4.liquid` (if section) OR
- `theme/snippets/sp-4.liquid` (if snippet/component)
...
```json
{
  "name": "SP_コレクションテンプレート（ブランド）_Frame 1608",
  "settings": [
    {
      "type": "text",
      "id": "heading",
