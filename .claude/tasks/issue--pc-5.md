# Task #: PC_コレクションテンプレート（ブランド）_plus_c

**GitHub Issue**: #
**Branch**: `issue--pc-5`
**Figma Link**: https://www.figma.com/design/5NQAM48PSavkdGzGHtipcD/%E3%80%90%E5%AE%8C%E4%BA%86%E3%80%91%E5%90%89%E5%B7%9D%E5%95%86%E4%BA%8B%E6%A0%AA%E5%BC%8F%E4%BC%9A%E7%A4%BE--Copy-?node-id=111-48{FIGMA_LINK}p=f{FIGMA_LINK}t=k4T5zU6D7Nbj7TcW-0{FIGMA_LINK}node-id=111-2526
**Complexity**: 5/10
**Created**: 2025-10-08T06:30:41Z
...
- [ ] BEM CSS classes applied (`.pc-5__element--modifier`)
- [ ] All styles in `css/pc-5.css`
- [ ] JavaScript in `js/pc-5.js` (if interactive)
- [ ] No hard-coded colors (use CSS variables)
- [ ] No magic numbers (use spacing variables)

### Automated Tests (Playwright)
Test file: `tests/pc-5.spec.js`
...
- [ ] HTML copied to `theme/{sections|snippets}/pc-5.liquid`
...
```
2025-10-08T06:30:41Z - Phase 1 started
2025-10-08T06:30:41Z - Figma analysis complete
2025-10-08T06:30:41Z - Phase 1 complete ✓

2025-10-08T06:30:41Z - Phase 2 started
2025-10-08T06:30:41Z - HTML structure created
2025-10-08T06:30:41Z - CSS implemented (BEM naming)
2025-10-08T06:30:41Z - JavaScript added (if needed)
2025-10-08T06:30:41Z - Playwright tests created
2025-10-08T06:30:41Z - Running visual validation...
2025-10-08T06:30:41Z - Test results: Desktop: _%, Tablet: _%, Mobile: _%
2025-10-08T06:30:41Z - Phase 2 complete ✓

2025-10-08T06:30:41Z - Phase 3 started
2025-10-08T06:30:41Z - HTML converted to Liquid
2025-10-08T06:30:41Z - Section schema added
2025-10-08T06:30:41Z - Shopify preview validated
2025-10-08T06:30:41Z - Phase 3 complete ✓

2025-10-08T06:30:41Z - **TASK COMPLETE - Ready for PR**
```
...
- `html/pc-5.html`
- `css/pc-5.css`
- `js/pc-5.js` (if interactive)
- `tests/pc-5.spec.js`
- `tests/screenshots/pc-5-desktop.png`
- `tests/screenshots/pc-5-tablet.png`
- `tests/screenshots/pc-5-mobile.png`

### Phase 3: Liquid Conversion
- `theme/sections/pc-5.liquid` (if section) OR
- `theme/snippets/pc-5.liquid` (if snippet/component)
...
```json
{
  "name": "PC_コレクションテンプレート（ブランド）_plus_c",
  "settings": [
    {
      "type": "text",
      "id": "heading",
